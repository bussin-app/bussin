        ...
        {user && <>
          <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.statsContainer}>
                  ...
                  <View style={styles.statsBox}>
                      <Text style={[styles.text, { fontSize: 24, borderRightWidth: 1 }]}>{user.friends.length}</Text>
                      <Text style={[styles.text, styles.subText]}>Friends</Text>
                  </View>
                  <View style={styles.statsBox}>
                      <Text style={[styles.text, { fontSize: 24 }]} onPress={() => props.navigation.navigate('FriendList')}>{user.organizations.length}</Text>
